export const IMAGES = {
    ...
    Home: require('../assets/images/icons/Sooperlogo.png'),
    heart: require('../assets/images/icons/heart.png'),
    mycart: require('../assets/images/icons/market (1).png'),
    mycartActive: require('../assets/images/icons/Bag.png'),
    myorders: require('../assets/images/icons/package.png'),
    myordersActive: require('../assets/images/icons/booking.png'),
    bookmark :require('../assets/images/icons/bookmark.png'),
    myordersprofile :  require('../assets/images/icons/clipboard.png'),
    Category: require('../assets/images/icons/category (1).png'),
    CategoryActive: require('../assets/images/icons/category.png'),
    ...
    support :require('../assets/images/icons/customer-support.png'),
